...
const HIGHSCORE_SET: &str = "blockparty_highscore_set";
const HIGHSCORE_GET: &str = "blockparty_highscore_get";

// Contract name
const CONTRACT_KEY: &str = "blockparty_highscore";

#[no_mangle]
pub extern "C" fn blockparty_highscore_set() {
...
#[no_mangle]
pub extern "C" fn blockparty_highscore_get() {
