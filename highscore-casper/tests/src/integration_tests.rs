...
mod tests {
    ...
    const HIGHSCORE_WASM: &str = "blockparty_highscore.wasm";

    const CONTRACT_KEY: &str = "blockparty_highscore";

    // Name of keys to store highest overall score and name
    const HIGHSCORE_KEY: &str = "blockparty_highest_score";
    const HIGHSCORE_USER_KEY: &str = "blockparty_highest_score_user";

    const ENTRY_POINT_HIGHSCORE_SET: &str = "blockparty_highscore_set"; // Entry point to set the highscore
    const ENTRY_POINT_HIGHSCORE_GET: &str = "blockparty_highscore_get"; // Entry point to get the highscore
